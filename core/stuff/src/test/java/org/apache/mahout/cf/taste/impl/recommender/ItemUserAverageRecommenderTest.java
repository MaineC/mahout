...
public final class ItemUserAverageRecommenderTest extends MahoutTestCase {

  @Test
  public void testRecommender() throws Exception {
    Recommender recommender = new ItemUserAverageRecommender(TasteTestUtils.getDataModel());
