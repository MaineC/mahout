  ...
  public void testFuzzyKMeansSeqJob() throws Exception {
    ...
    for (int k = 0; k < points.size(); k++) {
      ...
      /*      FuzzyKMeansDriver.runJob(pointsPath,
                                     ...
                                     0);
      */
      new FuzzyKMeansDriver().run(pointsPath, clustersPath, output, new EuclideanDistanceMeasure(),
          0.001, 2, 2.0f, true, true, 0.0, true);
  ...
  public void testFuzzyKMeansMRJob() throws Exception {
    ...
    for (int k = 0; k < points.size(); k++) {
      ...
      /*      FuzzyKMeansDriver.runJob(pointsPath,
                                     ...
                                     0);
      */
      FuzzyKMeansDriver.run(pointsPath, clustersPath, output, new EuclideanDistanceMeasure(), 0.001,
          2, 2.0f, true, true, 0, false);
