...
public class NaiveBayesTest extends MahoutTestCase {
  ...
  public void toyData() throws Exception {
    ...
    trainNaiveBayes.setTempPath(new Path(tempDir.getAbsolutePath()));
    trainNaiveBayes.run(new Path(inputFile.getAbsolutePath()), new Path(outputDir.getAbsolutePath()),
        false,
        "stolen,not_stolen");
  ...
  public void toyDataComplementary() throws Exception {
    TrainNaiveBayesJob trainNaiveBayes = new TrainNaiveBayesJob();
    trainNaiveBayes.setConf(conf);
    trainNaiveBayes.setTempPath(getTestTempDirPath());
    trainNaiveBayes.run(
