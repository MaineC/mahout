...
public final class TestDistributedRowMatrix extends MahoutTestCase {
  ...
  public void testMatrixColumnMeansJob() throws Exception {
    Matrix m =
        SolverTestHelper.randomSequentialAccessSparseMatrix(100, 90, 50, 20, 1.0);
  ...
  public void testNullMatrixColumnMeansJob() throws Exception {
    Matrix m =
        SolverTestHelper.randomSequentialAccessSparseMatrix(100, 90, 0, 0, 1.0);
    DistributedRowMatrix dm =
  ...
  public void testMatrixTimesVector() throws Exception {
    ...
    v.assign(1.0);
    Matrix m = SolverTestHelper.randomSequentialAccessSparseMatrix(100, 90, 50, 20, 1.0);
  ...
  public void testMatrixTimesMatrix() throws Exception {
    Matrix inputA = SolverTestHelper.randomSequentialAccessSparseMatrix(20, 19, 15, 5, 10.0);
    Matrix inputB = SolverTestHelper.randomSequentialAccessSparseMatrix(20, 13, 25, 10, 5.0);
  ...
  public DistributedRowMatrix randomDenseHierarchicalDistributedMatrix(int numRows,
    ...
    Matrix c = SolverTestHelper.randomHierarchicalMatrix(numRows, numCols, isSymmetric);
  ...
  public DistributedRowMatrix randomDistributedMatrix(int numRows,
    ...
    Path baseTmpDirPath = getTestTempDirPath(baseTmpDirSuffix);
    Matrix c = SolverTestHelper.randomSequentialAccessSparseMatrix(numRows, nonNullRows, numCols, entriesPerRow, entryMean);
    if (isSymmetric) {
