...
public final class TestMapReduce extends MahoutTestCase {
  ...
  public void testDriverIterationsSeq() throws Exception {
    ...
    driver.run(conf, getTestTempDirPath("input"), outputPath, description, 20, maxIterations, 1.0, true, false, 0, true);
    // and inspect results
  ...
  public void testDriverIterationsMR() throws Exception {
    ...
    HadoopUtil.delete(conf, outputPath);
    DirichletDriver driver = new DirichletDriver();
    driver.run(conf, getTestTempDirPath("input"), outputPath, description, 20, maxIterations, 1.0, true, false, 0, false);
    // and inspect results
    printModels(getClusters(outputPath, maxIterations));
  }
