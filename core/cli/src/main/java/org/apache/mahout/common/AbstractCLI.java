 ...
 * arguments.</p>
 */
public abstract class AbstractCLI extends org.apache.mahout.common.mapreduce.AbstractJob implements Tool {
  ...
  protected static boolean shouldRunNextPhase(Map<String, List<String>> args, AtomicInteger currentPhase) {
    ...
    return shouldRunNextPhase(start, end, currentPhase);
  }
