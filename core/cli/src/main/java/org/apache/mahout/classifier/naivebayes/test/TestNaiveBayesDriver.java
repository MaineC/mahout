...
import org.apache.mahout.classifier.naivebayes.NaiveBayesConfig;
 ...
 */
public class TestNaiveBayesDriver extends AbstractCLI {
  ...
  private boolean runMapReduce(Map<String, List<String>> parsedArgs) throws IOException,
    ...
    boolean complementary = parsedArgs.containsKey("testComplementary");
    testJob.getConfiguration().set(NaiveBayesConfig.COMPLEMENTARY, String.valueOf(complementary));
