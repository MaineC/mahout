...
import org.apache.mahout.clustering.meanshift.MeanShiftConfig;
...
public static DefaultOptionBuilder clusterFilterOption() {
  ...
  public static DefaultOptionBuilder inputIsCanopiesOption() {
    return new DefaultOptionBuilder()
        .withLongName(MeanShiftConfig.INPUT_IS_CANOPIES_OPTION)
        .withRequired(false)
        .withShortName("ic")
        .withArgument(
            new ArgumentBuilder()
                .withName(MeanShiftConfig.INPUT_IS_CANOPIES_OPTION)
                .withMinimum(1).withMaximum(1).create())
        .withDescription(
