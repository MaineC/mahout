...
import org.apache.mahout.vectorizer.collocations.llr.CollocConfig;
...
import static org.apache.mahout.vectorizer.term.DictionaryConfig.*;
    ...
    if (maxNGramSize == 1) {
      ...
      dictionaryChunks =
          createDictionaryChunks(new Path(new Path(output, DICTIONARY_JOB_FOLDER),
                                          CollocConfig.NGRAM_OUTPUT_DIRECTORY),
                                 output,
                                 baseConf,
